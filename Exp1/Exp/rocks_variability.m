...
if ~exist(filename)
    ...
    %
    if condition == 1
        train = [52 16 56 35 33 6 4 37 15 36 38 49 53 58 48 57 59 14 1 60  271 250 216 267 269 212 217 219 272 266 245 252 253 258 209 218 251 224 222 221   471 408 353 356 409 465 411 473 479 476 406 359 360 361 405 403 412 416 366 466];
    elseif condition == 2
